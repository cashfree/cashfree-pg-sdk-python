...
class LinkEntity(BaseModel):
    ...
    subscription: Optional[LinkSubscriptionEntity] = None
    __properties = ["cf_link_id", "link_id", "link_status", "link_currency", "link_amount", "link_amount_paid", "link_partial_payments", "link_minimum_partial_amount", "link_purpose", "link_created_at", "customer_details", "link_meta", "link_url", "link_expiry_time", "link_notes", "link_auto_reminders", "link_notify", "link_qrcode", "order_splits", "subscription"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> LinkEntity:
        ...
        if "cf_link_id, link_id, link_status, link_currency, link_amount, link_amount_paid, link_partial_payments, link_minimum_partial_amount, link_purpose, link_created_at, customer_details, link_meta, link_url, link_expiry_time, link_notes, link_auto_reminders, link_notify, link_qrcode, order_splits, subscription" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def from_dict(cls, obj: dict) -> LinkEntity:
        ...
        _obj = LinkEntity.parse_obj({
            ...
            "subscription": LinkSubscriptionEntity.from_dict(obj.get("subscription")) if obj.get("subscription") is not None else None
        })
        return _obj
