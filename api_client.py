...
import cashfree_pg_sdk_python.models
from cashfree_pg_sdk_python import rest
from cashfree_pg_sdk_python.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cashfree_pg_sdk_python.models, klass)
