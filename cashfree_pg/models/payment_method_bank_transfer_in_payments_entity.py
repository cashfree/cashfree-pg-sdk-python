...
class PaymentMethodBankTransferInPaymentsEntity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentMethodBankTransferInPaymentsEntity:
        """Create an instance of PaymentMethodBankTransferInPaymentsEntity from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> PaymentMethodBankTransferInPaymentsEntity:
        """Create an instance of PaymentMethodBankTransferInPaymentsEntity from a JSON string"""
        temp_dict = json.loads(json_str)
        if "banktransfer" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of banktransfer
        if self.banktransfer:
            _dict['banktransfer'] = self.banktransfer.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> PaymentMethodBankTransferInPaymentsEntity:
        """Create an instance of PaymentMethodBankTransferInPaymentsEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentMethodBankTransferInPaymentsEntity.parse_obj(obj)

        _obj = PaymentMethodBankTransferInPaymentsEntity.parse_obj({
            "banktransfer": PaymentMethodBankTransferInPaymentsEntityBanktransfer.from_dict(obj.get("banktransfer")) if obj.get("banktransfer") is not None else None
        })
        return _obj


# Pydantic v2: resolve forward references & Annotated types
PaymentMethodBankTransferInPaymentsEntity.model_rebuild()
