...
class AuthorizationInPaymentsEntity(BaseModel):
    ...
    """
    action: Optional[StrictStr] = Field(default=None, description="One of CAPTURE or VOID")
    status: Optional[StrictStr] = Field(default=None, description="One of SUCCESS or PENDING")
    captured_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The captured amount for this authorization request")
    start_time: Optional[StrictStr] = Field(default=None, description="Start time of this authorization hold (only for UPI)")
    end_time: Optional[StrictStr] = Field(default=None, description="End time of this authorization hold (only for UPI)")
    approve_by: Optional[StrictStr] = Field(default=None, description="Approve by time as passed in the authorization request (only for UPI)")
    action_reference: Optional[StrictStr] = Field(default=None, description="CAPTURE or VOID reference number based on action ")
    action_time: Optional[StrictStr] = Field(default=None, description="Time of action (CAPTURE or VOID)")
...
AuthorizationInPaymentsEntity.model_rebuild()
