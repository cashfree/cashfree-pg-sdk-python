...
class OrderEntity(BaseModel):
    ...
    def from_json_for_one_of(cls, json_str: str) -> OrderEntity:
        ...
        if temp_dict["cf_order_id, order_id, entity, order_currency, order_amount, order_status, payment_session_id, order_expiry_time, order_note, created_at, order_splits, customer_details, order_meta, payments, settlements, refunds, order_tags"] in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
