...
class SplitAfterPaymentRequest(BaseModel):
    ...
    """
    split: Optional[List[SplitAfterPaymentRequestSplitInner]] = Field(default=None, description="Specify the vendors order split details.")
    disable_split: Optional[StrictBool] = Field(default=None, description="Specify if you want to end the split or continue creating further splits in future.")
...
SplitAfterPaymentRequest.model_rebuild()
