...
class PaymentWebhookGatewayDetailsEntity(BaseModel):
    ...
    __properties = ["gateway_name", "gateway_order_id", "gateway_order_reference_id", "gateway_payment_id", "gateway_status_code", "gateway_settlement", "gateway_reference_name"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> PaymentWebhookGatewayDetailsEntity:
        ...
        if "gateway_name, gateway_order_id, gateway_order_reference_id, gateway_payment_id, gateway_status_code, gateway_settlement, gateway_reference_name" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
...
PaymentWebhookGatewayDetailsEntity.model_rebuild()
