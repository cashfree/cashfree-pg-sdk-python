...
class CreateOrderSettlementRequestBodyMetaData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrderSettlementRequestBodyMetaData:
        """Create an instance of CreateOrderSettlementRequestBodyMetaData from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> CreateOrderSettlementRequestBodyMetaData:
        """Create an instance of CreateOrderSettlementRequestBodyMetaData from a JSON string"""
        temp_dict = json.loads(json_str)
        if "cbriks_id, settlement_date" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrderSettlementRequestBodyMetaData:
        """Create an instance of CreateOrderSettlementRequestBodyMetaData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOrderSettlementRequestBodyMetaData.parse_obj(obj)

        _obj = CreateOrderSettlementRequestBodyMetaData.parse_obj({
            "cbriks_id": obj.get("cbriks_id"),
...
CreateOrderSettlementRequestBodyMetaData.model_rebuild()
