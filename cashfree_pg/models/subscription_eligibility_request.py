...
class SubscriptionEligibilityRequest(BaseModel):
    """
    Request body to fetch subscription eligibile payment method details.
    """
    queries: SubscriptionEligibilityRequestQueries = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionEligibilityRequest:
        """Create an instance of SubscriptionEligibilityRequest from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> SubscriptionEligibilityRequest:
        """Create an instance of SubscriptionEligibilityRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionEligibilityRequest:
