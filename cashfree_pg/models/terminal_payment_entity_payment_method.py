...
from typing import Union, Any, List, TYPE_CHECKING, Literal, Dict, Optional, Tuple
from pydantic import validate_arguments, ValidationError, Field, StrictStr, StrictBytes, StrictInt, StrictFloat, StrictBool, field_validator, BaseModel, validator
...
class TerminalPaymentEntityPaymentMethod(BaseModel):
    """
    ...
    # data type: PaymentMethodCardEMIInPaymentsEntity
    oneof_schema_7_validator: Optional[PaymentMethodCardEMIInPaymentsEntity] = None
    # data type: PaymentMethodBankTransferInPaymentsEntity
    oneof_schema_8_validator: Optional[PaymentMethodBankTransferInPaymentsEntity] = None
    if TYPE_CHECKING:
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = TerminalPaymentEntityPaymentMethod.construct()
        error_messages = []
        match = 0
        ...
        if not isinstance(v, PaymentMethodPaylaterInPaymentsEntity):
            ...
            match += 1
        # validate data type: PaymentMethodCardEMIInPaymentsEntity
        if not isinstance(v, PaymentMethodCardEMIInPaymentsEntity):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PaymentMethodCardEMIInPaymentsEntity`")
        else:
            match += 1
        # validate data type: PaymentMethodBankTransferInPaymentsEntity
        if not isinstance(v, PaymentMethodBankTransferInPaymentsEntity):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PaymentMethodBankTransferInPaymentsEntity`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in TerminalPaymentEntityPaymentMethod with oneOf schemas: PaymentMethodAppInPaymentsEntity, PaymentMethodBankTransferInPaymentsEntity, PaymentMethodCardEMIInPaymentsEntity, PaymentMethodCardInPaymentsEntity, PaymentMethodCardlessEMIInPaymentsEntity, PaymentMethodNetBankingInPaymentsEntity, PaymentMethodPaylaterInPaymentsEntity, PaymentMethodUPIInPaymentsEntity. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in TerminalPaymentEntityPaymentMethod with oneOf schemas: PaymentMethodAppInPaymentsEntity, PaymentMethodBankTransferInPaymentsEntity, PaymentMethodCardEMIInPaymentsEntity, PaymentMethodCardInPaymentsEntity, PaymentMethodCardlessEMIInPaymentsEntity, PaymentMethodNetBankingInPaymentsEntity, PaymentMethodPaylaterInPaymentsEntity, PaymentMethodUPIInPaymentsEntity. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> TerminalPaymentEntityPaymentMethod:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> TerminalPaymentEntityPaymentMethod:
        ...
        try:
            instance.actual_instance = PaymentMethodCardInPaymentsEntity.from_json_for_one_of(json_str)
            match += 1
        ...
        try:
            instance.actual_instance = PaymentMethodNetBankingInPaymentsEntity.from_json_for_one_of(json_str)
            match += 1
            if (instance.actual_instance is not None):
                return instance
        except (ValidationError, ValueError) as e:
        ...
        try:
            instance.actual_instance = PaymentMethodUPIInPaymentsEntity.from_json_for_one_of(json_str)
            match += 1
            if (instance.actual_instance is not None):
                return instance
        except (ValidationError, ValueError) as e:
        ...
        try:
            instance.actual_instance = PaymentMethodAppInPaymentsEntity.from_json_for_one_of(json_str)
            match += 1
            if (instance.actual_instance is not None):
                return instance
        except (ValidationError, ValueError) as e:
        ...
        try:
            instance.actual_instance = PaymentMethodCardlessEMIInPaymentsEntity.from_json_for_one_of(json_str)
            match += 1
            if (instance.actual_instance is not None):
                return instance
        except (ValidationError, ValueError) as e:
        ...
        try:
            instance.actual_instance = PaymentMethodPaylaterInPaymentsEntity.from_json_for_one_of(json_str)
            match += 1
            if (instance.actual_instance is not None):
                return instance
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into PaymentMethodCardEMIInPaymentsEntity
        try:
            instance.actual_instance = PaymentMethodCardEMIInPaymentsEntity.from_json_for_one_of(json_str)
            match += 1
            if (instance.actual_instance is not None):
                return instance
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into PaymentMethodBankTransferInPaymentsEntity
        try:
            instance.actual_instance = PaymentMethodBankTransferInPaymentsEntity.from_json_for_one_of(json_str)
            match += 1
            if (instance.actual_instance is not None):
                return instance
        except (ValidationError, ValueError) as e:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into TerminalPaymentEntityPaymentMethod with oneOf schemas: PaymentMethodAppInPaymentsEntity, PaymentMethodBankTransferInPaymentsEntity, PaymentMethodCardEMIInPaymentsEntity, PaymentMethodCardInPaymentsEntity, PaymentMethodCardlessEMIInPaymentsEntity, PaymentMethodNetBankingInPaymentsEntity, PaymentMethodPaylaterInPaymentsEntity, PaymentMethodUPIInPaymentsEntity. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
...
TerminalPaymentEntityPaymentMethod.model_rebuild()
