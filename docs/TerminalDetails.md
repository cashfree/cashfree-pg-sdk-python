...
**terminal_id** | **str** | terminal id for merchant reference | [optional] 
...
**terminal_phone_no** | **str** | mobile num of the terminal/agent/storefront,This is a required parameter when you do not provide the cf_terminal_id. | 
...
terminal_details_from_dict = TerminalDetails.from_dict(terminal_details_dict)
```
