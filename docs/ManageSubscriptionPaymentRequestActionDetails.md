...
manage_subscription_payment_request_action_details_from_dict = ManageSubscriptionPaymentRequestActionDetails.from_dict(manage_subscription_payment_request_action_details_dict)
```
