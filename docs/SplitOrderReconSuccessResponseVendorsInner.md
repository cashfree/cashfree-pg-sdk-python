...
**settlement_eligibility_date** | **str** | Date and time when the vendor is eligible for the settlement. | [optional] 
...
split_order_recon_success_response_vendors_inner_form_dict = split_order_recon_success_response_vendors_inner.from_dict(split_order_recon_success_response_vendors_inner_dict)
```
