...
class UPIAuthorizeDetails(BaseModel):
    ...
    """
    approve_by: Optional[StrictStr] = Field(default=None, description="Time by which this authorization should be approved by the customer.")
    start_time: Optional[StrictStr] = Field(default=None, description="This is the time when the UPI one time mandate will start")
    end_time: Optional[StrictStr] = Field(default=None, description="This is the time when the UPI mandate will be over. If the mandate has not been executed by this time, the funds will be returned back to the customer after this time.")
...
UPIAuthorizeDetails.model_rebuild()
