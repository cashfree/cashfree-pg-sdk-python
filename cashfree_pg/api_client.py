...
from cashfree_pg.models.fetch_active_ecosystem_downtimes200_response import *
...
from cashfree_pg.models.pg_create_par200_response import *
...
class Cashfree:
    ...
    def PGCreateCustomer(self, create_customer_request : Annotated[CreateCustomerRequest, Field(description="Request to create a new customer at Cashfree.")] = None, x_request_id : Annotated[Optional[StrictStr], Field(description="Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree.")] = None, x_idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions. ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        _header_params["x-sdk-platform"] = "pythonsdk-6.0.1"
