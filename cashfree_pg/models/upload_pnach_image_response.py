...
class UploadPnachImageResponse(BaseModel):
    ...
    authorization_status: Optional[StrictStr] = Field(default=None, description="Authorization status of the subscription.")
    action: Optional[StrictStr] = Field(default=None, description="Action performed on the file.")
    payment_message: Optional[StrictStr] = Field(default=None, description="Message of the API.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadPnachImageResponse:
        """Create an instance of UploadPnachImageResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> UploadPnachImageResponse:
        """Create an instance of UploadPnachImageResponse from a JSON string"""
        temp_dict = json.loads(json_str)
        if "payment_id, authorization_status, action, payment_message" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadPnachImageResponse:
        """Create an instance of UploadPnachImageResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UploadPnachImageResponse.parse_obj(obj)

        _obj = UploadPnachImageResponse.parse_obj({
...
UploadPnachImageResponse.model_rebuild()
