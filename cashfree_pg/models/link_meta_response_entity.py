...
class LinkMetaResponseEntity(BaseModel):
    ...
    """
    notify_url: Optional[StrictStr] = Field(default=None, description="Notification URL for server-server communication. It should be an https URL.")
    upi_intent: Optional[StrictStr] = Field(default=None, description="If \"true\", link will directly open UPI Intent flow on mobile, and normal link flow elsewhere")
    return_url: Optional[StrictStr] = Field(default=None, description="The URL to which user will be redirected to after the payment is done on the link. Maximum length: 250.")
    payment_methods: Optional[StrictStr] = Field(default=None, description="Allowed payment modes for this link. Pass comma-separated values among following options - \"cc\", \"dc\", \"ccc\", \"ppc\", \"nb\", \"upi\", \"paypal\", \"app\". Leave it blank to show all available payment methods")
...
LinkMetaResponseEntity.model_rebuild()
