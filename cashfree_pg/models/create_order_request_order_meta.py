...
class CreateOrderRequestOrderMeta(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrderRequestOrderMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrderRequestOrderMeta:
        """Create an instance of CreateOrderRequestOrderMeta from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOrderRequestOrderMeta.parse_obj(obj)

        _obj = CreateOrderRequestOrderMeta.parse_obj({
