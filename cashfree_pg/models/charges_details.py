...
class ChargesDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChargesDetails:
        """Create an instance of ChargesDetails from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> ChargesDetails:
        """Create an instance of ChargesDetails from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChargesDetails:
        """Create an instance of ChargesDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChargesDetails.parse_obj(obj)

        _obj = ChargesDetails.parse_obj({
