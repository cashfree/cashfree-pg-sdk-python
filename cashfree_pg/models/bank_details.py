...
class BankDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankDetails:
        """Create an instance of BankDetails from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> BankDetails:
        """Create an instance of BankDetails from a JSON string"""
        temp_dict = json.loads(json_str)
        if "account_number, account_holder, ifsc" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankDetails:
        """Create an instance of BankDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankDetails.model_validate(obj)

        _obj = BankDetails.model_validate({
