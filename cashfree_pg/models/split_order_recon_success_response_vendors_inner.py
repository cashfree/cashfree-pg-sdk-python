...
class SplitOrderReconSuccessResponseVendorsInner(BaseModel):
    ...
    settlement_eligibility_date: Optional[StrictStr] = Field(default=None, description="Date and time when the vendor is eligible for the settlement.")
...
SplitOrderReconSuccessResponseVendorsInner.model_rebuild()
