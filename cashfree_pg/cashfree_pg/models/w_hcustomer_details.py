...
class WHcustomerDetails(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WHcustomerDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WHcustomerDetails:
        """Create an instance of WHcustomerDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WHcustomerDetails.parse_obj(obj)

        _obj = WHcustomerDetails.parse_obj({
