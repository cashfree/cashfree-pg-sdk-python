...
# **PGCreateOrder**
> OrderEntity PGCreateOrder(x_api_version, create_order_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
from pprint import pprint
    ...
    try:
        # Create Order
        api_response = Cashfree().PGCreateOrder(x_api_version, create_order_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of OrdersApi->PGCreateOrder:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->PGCreateOrder: %s\n" % e)
```
...
# **PGFetchOrder**
> OrderEntity PGFetchOrder(x_api_version, order_id, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
from pprint import pprint
    ...
    try:
        # Get Order
        api_response = Cashfree().PGFetchOrder(x_api_version, order_id, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of OrdersApi->PGFetchOrder:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->PGFetchOrder: %s\n" % e)
```
...
# **PGTerminateOrder**
> OrderEntity PGTerminateOrder(x_api_version, order_id, terminate_order_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
from pprint import pprint
    ...
    try:
        # Terminate Order
        api_response = Cashfree().PGTerminateOrder(x_api_version, order_id, terminate_order_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of OrdersApi->PGTerminateOrder:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->PGTerminateOrder: %s\n" % e)
```
