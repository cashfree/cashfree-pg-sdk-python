# cashfree_pg.UtilitiesApi

All URIs are relative to *https://sandbox.cashfree.com/pg*

Method | HTTP request | Description
------------- | ------------- | -------------
[**p_g_create_par**](UtilitiesApi.md#p_g_create_par) | **POST** /pg/utilities/pars | Create PAR at Cashfree


# **p_g_create_par**
> PGCreatePAR200Response p_g_create_par(x_api_version, par_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
from cashfree_pg.models.pg_create_par200_response import PGCreatePAR200Response
...
with cashfree_pg.ApiClient(configuration) as api_client:
    ...
    api_instance = cashfree_pg.UtilitiesApi(api_client)
    x_api_version = '2025-01-01' # str | API version to be used. Format is in YYYY-MM-DD (default to '2025-01-01')
    par_request = cashfree_pg.PARRequest() # PARRequest | Request payload for creating PAR.
    ...
    try:
        # Create PAR at Cashfree
        api_response = api_instance.p_g_create_par(x_api_version, par_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of UtilitiesApi->p_g_create_par:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UtilitiesApi->p_g_create_par: %s\n" % e)
```
 ...
 **par_request** | [**PARRequest**](PARRequest.md)| Request payload for creating PAR. | 
