...
class OfferTncResponse(BaseModel):
    """
    Offer terms and condition object.
    """
    offer_tnc_type: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=50)]] = Field(default=None, description="TnC Type for the Offer. It can be either `text` or `link`.")
    offer_tnc_value: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=100)]] = Field(default=None, description="TnC for the Offer.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferTncResponse:
        """Create an instance of OfferTncResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> OfferTncResponse:
        """Create an instance of OfferTncResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OfferTncResponse:
        """Create an instance of OfferTncResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OfferTncResponse.parse_obj(obj)

        _obj = OfferTncResponse.parse_obj({
...
OfferTncResponse.model_rebuild()
