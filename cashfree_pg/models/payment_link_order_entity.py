...
class PaymentLinkOrderEntity(BaseModel):
    ...
    def from_json_for_one_of(cls, json_str: str) -> PaymentLinkOrderEntity:
        """Create an instance of PaymentLinkOrderEntity from a JSON string"""
        if "cf_order_idlink_idorder_identityorder_currencyorder_amountorder_statuspayment_session_idorder_expiry_timeorder_notecreated_atorder_splitscustomer_detailsorder_metapaymentssettlementsrefundsorder_tags" not in json_str:
            return None
        return cls.from_dict(json.loads(json_str))
