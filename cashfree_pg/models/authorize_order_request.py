...
class AuthorizeOrderRequest(BaseModel):
    ...
    """
    action: Optional[StrictStr] = Field(None, description="Type of authorization to run. Can be one of 'CAPTURE' , 'VOID'")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthorizeOrderRequest:
  ...
  &quot;enum&quot; : [ &quot;CAPTURE&quot;, &quot;VOID&quot; ]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthorizeOrderRequest:
