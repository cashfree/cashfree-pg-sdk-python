...
class LinkCustomerDetailsEntity(BaseModel):
    ...
    customer_bank_code: Optional[StrictInt] = Field(default=None, description="Customer Bank Code.")
    customer_bank_acoount_holder_name: Optional[StrictStr] = Field(default=None, description="Customer Bank Account Holder Name.")
    __properties = ["customer_phone", "customer_email", "customer_name", "customer_bank_account_number", "customer_bank_ifsc", "customer_bank_code", "customer_bank_acoount_holder_name"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> LinkCustomerDetailsEntity:
        ...
        if "customer_phone, customer_email, customer_name, customer_bank_account_number, customer_bank_ifsc, customer_bank_code, customer_bank_acoount_holder_name" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def from_dict(cls, obj: dict) -> LinkCustomerDetailsEntity:
        ...
        _obj = LinkCustomerDetailsEntity.parse_obj({
            ...
            "customer_bank_acoount_holder_name": obj.get("customer_bank_acoount_holder_name")
        })
        return _obj
