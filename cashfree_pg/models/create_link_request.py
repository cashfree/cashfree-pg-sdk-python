...
from pydantic import BaseModel, Field, StrictBool, StrictFloat, StrictInt, StrictStr, conlist, constr, ConfigDict
...
class CreateLinkRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CreateLinkRequest:
        ...
        if not isinstance(obj, dict):
            return CreateLinkRequest.model_validate(obj)

        _obj = CreateLinkRequest.model_validate({
