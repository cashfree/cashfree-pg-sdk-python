...
create_subscription_request_subscription_meta_from_dict = CreateSubscriptionRequestSubscriptionMeta.from_dict(create_subscription_request_subscription_meta_dict)
```
