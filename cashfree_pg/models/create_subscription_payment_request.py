...
class CreateSubscriptionPaymentRequest(BaseModel):
    ...
    payment_schedule_date: Optional[StrictStr] = Field(default=None, description="The date on which the payment is scheduled to be processed. Required for UPI and CARD payment modes.")
