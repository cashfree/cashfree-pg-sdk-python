...
class TerminalPaymentEntity(BaseModel):
    ...
    __properties = ["cf_payment_id", "order_id", "entity", "error_details", "is_captured", "order_amount", "payment_group", "payment_currency", "payment_amount", "payment_time", "payment_completion_time", "payment_status", "payment_message", "bank_reference", "auth_id", "authorization", "customer_details", "payment_method", "payment_gateway_details"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> TerminalPaymentEntity:
        ...
        if "cf_payment_id, order_id, entity, error_details, is_captured, order_amount, payment_group, payment_currency, payment_amount, payment_time, payment_completion_time, payment_status, payment_message, bank_reference, auth_id, authorization, customer_details, payment_method, payment_gateway_details" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
...
TerminalPaymentEntity.model_rebuild()
