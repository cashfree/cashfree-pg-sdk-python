...
class CreatePartnerVpaRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePartnerVpaRequest:
        """Create an instance of CreatePartnerVpaRequest from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> CreatePartnerVpaRequest:
        """Create an instance of CreatePartnerVpaRequest from a JSON string"""
        temp_dict = json.loads(json_str)
        if "vpa_count" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePartnerVpaRequest:
...
CreatePartnerVpaRequest.model_rebuild()
