...
class InternationalPaymentEntity(BaseModel):
    """
    International payment details.
    """
    international: Optional[StrictBool] = None
    __properties = ["international"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternationalPaymentEntity:
        """Create an instance of InternationalPaymentEntity from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> InternationalPaymentEntity:
        """Create an instance of InternationalPaymentEntity from a JSON string"""
        temp_dict = json.loads(json_str)
        if "international" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternationalPaymentEntity:
        """Create an instance of InternationalPaymentEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InternationalPaymentEntity.parse_obj(obj)

        _obj = InternationalPaymentEntity.parse_obj({
...
InternationalPaymentEntity.model_rebuild()
