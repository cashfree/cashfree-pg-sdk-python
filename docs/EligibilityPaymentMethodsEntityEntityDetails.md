...
eligibility_payment_methods_entity_entity_details_from_dict = EligibilityPaymentMethodsEntityEntityDetails.from_dict(eligibility_payment_methods_entity_entity_details_dict)
```
