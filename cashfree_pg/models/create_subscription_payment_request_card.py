...
class CreateSubscriptionPaymentRequestCard(BaseModel):
    ...
    payment method card.
    """
    card: Optional[CreateSubscriptionPaymentRequestCardCard] = None
    __properties = ["card"]
    ...
    def from_dict(cls, obj: dict) -> CreateSubscriptionPaymentRequestCard:
        ...
        _obj = CreateSubscriptionPaymentRequestCard.parse_obj({
            "card": CreateSubscriptionPaymentRequestCardCard.from_dict(obj.get("card")) if obj.get("card") is not None else None
        })
        return _obj
