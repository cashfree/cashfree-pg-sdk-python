...
class SettlementEntity(BaseModel):
    ...
    def from_json_for_one_of(cls, json_str: str) -> SettlementEntity:
        """Create an instance of SettlementEntity from a JSON string"""
        if "cf_payment_idcf_settlement_idsettlement_currencyorder_identityorder_amountpayment_timeservice_chargeservice_taxsettlement_amountsettlement_idtransfer_idtransfer_timetransfer_utr" not in json_str:
            return None
        return cls.from_dict(json.loads(json_str))
