...
------------ | ------------- | ------------- | -------------
**vendor_id** | **str** | Vendor id created in Cashfree system | 
...
**tags** | **Dict[str, object]** | Custom Tags in thr form of {\&quot;key\&quot;:\&quot;value\&quot;} which can be passed for an order. A maximum of 10 tags can be added | [optional] 
...
vendor_split_from_dict = VendorSplit.from_dict(vendor_split_dict)
```
