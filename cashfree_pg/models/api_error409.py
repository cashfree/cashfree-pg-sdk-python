...
class ApiError409(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="invalid_request_error.")
    __properties = ["message", "help", "code", "type"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> ApiError409:
        ...
        if "message, help, code, type" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
