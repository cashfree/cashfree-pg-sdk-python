...
es_order_recon_response_data_inner_order_splits_inner_form_dict = es_order_recon_response_data_inner_order_splits_inner.from_dict(es_order_recon_response_data_inner_order_splits_inner_dict)
```
