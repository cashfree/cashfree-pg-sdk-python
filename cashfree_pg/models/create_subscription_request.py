...
class CreateSubscriptionRequest(BaseModel):
    ...
    subscription_expiry_time: Optional[StrictStr] = Field(default=None, description="Expiry date for the subscription.")
    subscription_first_charge_time: Optional[StrictStr] = Field(default=None, description="Time at which the first charge will be made for the subscription after authorization. Applicable only for PERIODIC plans.")
