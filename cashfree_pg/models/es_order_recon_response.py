...
class ESOrderReconResponse(BaseModel):
    ...
    data: Optional[List[ESOrderReconResponseDataInner]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ESOrderReconResponse:
        """Create an instance of ESOrderReconResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> ESOrderReconResponse:
        """Create an instance of ESOrderReconResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ESOrderReconResponse:
        """Create an instance of ESOrderReconResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ESOrderReconResponse.parse_obj(obj)

        _obj = ESOrderReconResponse.parse_obj({
            "cursor": obj.get("cursor"),
            "data": [ESOrderReconResponseDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "limit": obj.get("limit")
        })
        return _obj
...
ESOrderReconResponse.model_rebuild()
