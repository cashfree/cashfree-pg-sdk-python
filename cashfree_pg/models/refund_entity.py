...
class RefundEntity(BaseModel):
    ...
    __properties = ["cf_payment_id", "cf_refund_id", "order_id", "refund_id", "entity", "refund_amount", "refund_currency", "refund_note", "refund_status", "refund_arn", "refund_charge", "status_description", "metadata", "refund_splits", "refund_type", "refund_mode", "created_at", "processed_at", "refund_speed", "forex_conversion_handling_charge", "forex_conversion_handling_tax", "forex_conversion_rate", "charges_currency"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> RefundEntity:
        ...
        if "cf_payment_id, cf_refund_id, order_id, refund_id, entity, refund_amount, refund_currency, refund_note, refund_status, refund_arn, refund_charge, status_description, metadata, refund_splits, refund_type, refund_mode, created_at, processed_at, refund_speed, forex_conversion_handling_charge, forex_conversion_handling_tax, forex_conversion_rate, charges_currency" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
