...
payment_method_bank_transfer_in_payments_entity_banktransfer_from_dict = PaymentMethodBankTransferInPaymentsEntityBanktransfer.from_dict(payment_method_bank_transfer_in_payments_entity_banktransfer_dict)
```
