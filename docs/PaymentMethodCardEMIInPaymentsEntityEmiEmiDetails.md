...
payment_method_card_emiin_payments_entity_emi_emi_details_from_dict = PaymentMethodCardEMIInPaymentsEntityEmiEmiDetails.from_dict(payment_method_card_emiin_payments_entity_emi_emi_details_dict)
```
