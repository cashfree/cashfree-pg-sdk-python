...
class TerminalDetails(BaseModel):
    ...
    terminal_phone_no: Optional[StrictStr] = Field(default=None, description="mobile num of the terminal/agent/storefront,This is a required parameter when you do not provide the cf_terminal_id.")
