...
**forex_conversion_handling_charge** | **float** | Cashfree forex conversion charges for refund processing | [optional] 
**forex_conversion_handling_tax** | **float** | Cashfree forex conversion tax for refund processing | [optional] 
**forex_conversion_rate** | **float** | Cashfree forex conversion rate for refund processing | [optional] 
**charges_currency** | **str** | Cashfree refund charges currency for a refund | [optional] 
