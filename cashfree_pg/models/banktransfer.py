...
class Banktransfer(BaseModel):
    ...
    """
    channel: Optional[StrictStr] = Field(default=None, description="The channel for bank transfer is always `link`.")
    ...
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> Banktransfer:
        """Create an instance of Banktransfer from a JSON string"""
        temp_dict = json.loads(json_str)
        if "channel" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
