...
class CreateTerminalTransactionRequest(BaseModel):
    ...
    cf_terminal_id: Optional[StrictStr] = Field(default=None, description="cashfree terminal id. this is a required parameter when you do not provide the terminal phone number.")
    payment_method: Annotated[str, Field(min_length=3, strict=True, max_length=100)] = Field(description="mention the payment method used for the transaction. possible values - QR_CODE, LINK.")
