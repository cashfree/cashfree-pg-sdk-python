...
class UpiDetails(BaseModel):
    ...
    __properties = ["vpa", "account_holder"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpiDetails:
        """Create an instance of UpiDetails from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> UpiDetails:
        """Create an instance of UpiDetails from a JSON string"""
        temp_dict = json.loads(json_str)
        if "vpa, account_holder" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpiDetails:
        """Create an instance of UpiDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpiDetails.parse_obj(obj)

        _obj = UpiDetails.parse_obj({
            "vpa": obj.get("vpa"),
