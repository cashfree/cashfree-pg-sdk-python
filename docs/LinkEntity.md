...
**link_qrcode** | **str** | Base64 encoded string for payment link. You can scan with camera to open a link in the browser to complete the payment. | [optional] 
...
link_entity_from_dict = LinkEntity.from_dict(link_entity_dict)
```
