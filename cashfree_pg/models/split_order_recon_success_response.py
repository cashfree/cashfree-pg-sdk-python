...
class SplitOrderReconSuccessResponse(BaseModel):
    ...
    refunds: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of refunds associated with the order, if any.")
    vendors: Optional[List[SplitOrderReconSuccessResponseVendorsInner]] = Field(default=None, description="List of vendor settlements associated with the split settlement.")
...
SplitOrderReconSuccessResponse.model_rebuild()
