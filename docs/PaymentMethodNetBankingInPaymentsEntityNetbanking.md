...
**netbanking_ifsc** | **str** |  | [optional] 
**netbanking_account_number** | **str** |  | [optional] 
...
payment_method_net_banking_in_payments_entity_netbanking_from_dict = PaymentMethodNetBankingInPaymentsEntityNetbanking.from_dict(payment_method_net_banking_in_payments_entity_netbanking_dict)
```
