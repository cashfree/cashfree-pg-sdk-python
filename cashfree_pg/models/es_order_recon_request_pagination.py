...
class ESOrderReconRequestPagination(BaseModel):
    ...
    limit: Optional[StrictInt] = Field(default=None, description="Set the minimum/maximum limit for number of filtered data. Min value - 10, Max value - 100.")
...
ESOrderReconRequestPagination.model_rebuild()
