...
# **SposCreateTerminal**
> TerminalEntity SposCreateTerminal(x_api_version, create_terminal_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
from pprint import pprint
    ...
    try:
        # Create Terminal
        api_response = Cashfree().SposCreateTerminal(x_api_version, create_terminal_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of SoftPOSApi->SposCreateTerminal:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoftPOSApi->SposCreateTerminal: %s\n" % e)
```
...
from pprint import pprint
    ...
    try:
        ...
        print("Exception when calling SoftPOSApi->SposCreateTerminalTransaction: %s\n" % e)
```
...
# **SposFetchTerminal**
> TerminalEntity SposFetchTerminal(x_api_version, terminal_phone_no, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
from pprint import pprint
    ...
    try:
        # Get terminal status using phone number
        api_response = Cashfree().SposFetchTerminal(x_api_version, terminal_phone_no, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of SoftPOSApi->SposFetchTerminal:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoftPOSApi->SposFetchTerminal: %s\n" % e)
```
...
> List[FetchTerminalQRCodesEntity] SposFetchTerminalQrCodes(x_api_version, terminal_phone_no, cf_terminal_id, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
from pprint import pprint
    ...
    try:
        # Fetch Terminal QR Codes
        api_response = Cashfree().SposFetchTerminalQrCodes(x_api_version, terminal_phone_no, cf_terminal_id, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of SoftPOSApi->SposFetchTerminalQrCodes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoftPOSApi->SposFetchTerminalQrCodes: %s\n" % e)
```
