...
class FetchSettlementsRequest(BaseModel):
    """
    Request to fetch settlement.
    """
    pagination: FetchSettlementsRequestPagination
    filters: Optional[FetchSettlementsRequestFilters] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FetchSettlementsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FetchSettlementsRequest:
        """Create an instance of FetchSettlementsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FetchSettlementsRequest.parse_obj(obj)

        _obj = FetchSettlementsRequest.parse_obj({
...
FetchSettlementsRequest.model_rebuild()
