...
class PaymentEntity(BaseModel):
    ...
    def from_json_for_one_of(cls, json_str: str) -> PaymentEntity:
        """Create an instance of PaymentEntity from a JSON string"""
        if "cf_payment_idorder_identityerror_detailsis_capturedorder_amountpayment_grouppayment_currencypayment_amountpayment_timepayment_completion_timepayment_statuspayment_messagebank_referenceauth_idauthorizationpayment_method" not in json_str:
            return None
        return cls.from_dict(json.loads(json_str))
