...
class OfferExtendedDetails(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferExtendedDetails:
        """Create an instance of OfferExtendedDetails from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> OfferExtendedDetails:
        """Create an instance of OfferExtendedDetails from a JSON string"""
        temp_dict = json.loads(json_str)
        if "offer_id, offer_status, offer_meta, offer_tnc, offer_details, offer_validations" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OfferExtendedDetails:
        """Create an instance of OfferExtendedDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OfferExtendedDetails.parse_obj(obj)

        _obj = OfferExtendedDetails.parse_obj({
...
OfferExtendedDetails.model_rebuild()
