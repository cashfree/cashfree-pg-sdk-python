...
class Subscription(BaseModel):
    ...
    """
    subscription_id: Optional[StrictStr] = Field(default=None, description="Unique ID for the subscription. This is generated by the merchant and should be unique across the system.")
    ...
    plan_details: Optional[CreateLinkPlanRequest] = None
    ...
    __properties = ["subscription_id", "authorization_amount", "plan_details", "authorization_amount_refund", "subscription_expiry_time", "subscription_first_charge_time"]
    ...
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> Subscription:
        """Create an instance of Subscription from a JSON string"""
        temp_dict = json.loads(json_str)
        if "subscription_id, authorization_amount, plan_details, authorization_amount_refund, subscription_expiry_time, subscription_first_charge_time" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def from_dict(cls, obj: dict) -> Subscription:
        ...
        _obj = Subscription.parse_obj({
            ...
            "plan_details": CreateLinkPlanRequest.from_dict(obj.get("plan_details")) if obj.get("plan_details") is not None else None,
