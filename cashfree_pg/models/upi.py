...
class Upi(BaseModel):
    ...
    """
    channel: Optional[StrictStr] = Field(default=None, description="Specify the channel through which the payment must be processed. Can be one of [\"link\", \"collect\", \"qrcode\", \"podQrCode\"].")
    ...
    def channel_validate_enum(cls, value):
        ...
        if value not in ('link', 'collect', 'qrcode', 'podQrCode'):
            raise ValueError("must be one of enum values ('link', 'collect', 'qrcode', 'podQrCode')")
        return value
