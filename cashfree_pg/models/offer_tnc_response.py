...
export interface OfferTncResponse {
     ...
     */
    'offer_tnc_type'?: Offer_tnc_typeEnum;
    /**
     * TnC for the Offer.
     * @type {str}
     * @memberof OfferTncResponse
...
export const Offer_tnc_typeEnum = {
    'text': 'text',
    'link': 'link',
    'unknown_default_open_api': 'unknown_default_open_api'
} as const;

export type Offer_tnc_typeEnum = typeof Offer_tnc_typeEnum[keyof typeof Offer_tnc_typeEnum];
