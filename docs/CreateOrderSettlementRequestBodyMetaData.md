...
create_order_settlement_request_body_meta_data_from_dict = CreateOrderSettlementRequestBodyMetaData.from_dict(create_order_settlement_request_body_meta_data_dict)
```
