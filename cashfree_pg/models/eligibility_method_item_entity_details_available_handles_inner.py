...
class EligibilityMethodItemEntityDetailsAvailableHandlesInner(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> EligibilityMethodItemEntityDetailsAvailableHandlesInner:
        ...
        if not isinstance(obj, dict):
            return EligibilityMethodItemEntityDetailsAvailableHandlesInner.model_validate(obj)

        _obj = EligibilityMethodItemEntityDetailsAvailableHandlesInner.model_validate({
