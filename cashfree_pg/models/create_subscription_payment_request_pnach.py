...
class CreateSubscriptionPaymentRequestPnach(BaseModel):
    ...
    """
    pnach: Optional[CreateSubscriptionPaymentRequestPnachPnach] = None
    __properties = ["pnach"]
    ...
    def from_dict(cls, obj: dict) -> CreateSubscriptionPaymentRequestPnach:
        ...
        _obj = CreateSubscriptionPaymentRequestPnach.parse_obj({
            "pnach": CreateSubscriptionPaymentRequestPnachPnach.from_dict(obj.get("pnach")) if obj.get("pnach") is not None else None
        })
        return _obj
