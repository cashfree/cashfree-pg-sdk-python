...
class PaymentMethodCardInPaymentsEntityCard(BaseModel):
    ...
    def from_json_for_one_of(cls, json_str: str) -> PaymentMethodCardInPaymentsEntityCard:
        ...
        if "channel, card_number, card_network, card_type, card_country, card_bank_name, card_network_reference_id" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def from_dict(cls, obj: dict) -> PaymentMethodCardInPaymentsEntityCard:
        ...
        if not isinstance(obj, dict):
            return PaymentMethodCardInPaymentsEntityCard.model_validate(obj)

        _obj = PaymentMethodCardInPaymentsEntityCard.model_validate({
