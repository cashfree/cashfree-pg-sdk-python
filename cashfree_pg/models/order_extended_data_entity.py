...
class OrderExtendedDataEntity(BaseModel):
    ...
    offers: Optional[List[OfferExtendedDetails]] = None
    __properties = ["cf_order_id", "order_id", "order_amount", "order_currency", "created_at", "charges", "customer_details", "shipping_address", "billing_address", "cart", "offers"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> OrderExtendedDataEntity:
        ...
        if "cf_order_id, order_id, order_amount, order_currency, created_at, charges, customer_details, shipping_address, billing_address, cart, offers" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def from_dict(cls, obj: dict) -> OrderExtendedDataEntity:
        ...
        _obj = OrderExtendedDataEntity.parse_obj({
            ...
            "offers": [OfferExtendedDetails.from_dict(_item) for _item in obj.get("offers")] if obj.get("offers") is not None else None
        })
        return _obj


# Pydantic v2: resolve forward references & Annotated types
OrderExtendedDataEntity.model_rebuild()
