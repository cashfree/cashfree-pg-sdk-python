...
class ChargesEntity(BaseModel):
    ...
    """
    shipping_charges: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Shipping charge of the order")
    cod_handling_charges: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="COD handling fee for order")
