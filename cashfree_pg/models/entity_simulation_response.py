...
class EntitySimulationResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntitySimulationResponse:
        """Create an instance of EntitySimulationResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> EntitySimulationResponse:
        """Create an instance of EntitySimulationResponse from a JSON string"""
        temp_dict = json.loads(json_str)
        if "payment_status, payment_error_code" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntitySimulationResponse:
        """Create an instance of EntitySimulationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntitySimulationResponse.parse_obj(obj)

        _obj = EntitySimulationResponse.parse_obj({
            "payment_status": obj.get("payment_status"),
            "payment_error_code": obj.get("payment_error_code")
        })
        return _obj


# Pydantic v2: resolve forward references & Annotated types
EntitySimulationResponse.model_rebuild()
