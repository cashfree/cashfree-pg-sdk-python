...
class CreateSubscriptionRequestSubscriptionMeta(BaseModel):
    ...
    """
    return_url: Optional[StrictStr] = Field(default=None, description="The url to redirect after checkout.")
    notification_channel: Optional[List[StrictStr]] = Field(default=None, description="Notification channel for the subscription. SMS, EMAIL are possible values.")
    session_id_expiry: Optional[StrictStr] = Field(default=None, description="Expiry date for the subscription session.")
    __properties = ["return_url", "notification_channel", "session_id_expiry"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> CreateSubscriptionRequestSubscriptionMeta:
        ...
        if "return_url, notification_channel, session_id_expiry" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def from_dict(cls, obj: dict) -> CreateSubscriptionRequestSubscriptionMeta:
        ...
        _obj = CreateSubscriptionRequestSubscriptionMeta.parse_obj({
            ...
            "session_id_expiry": obj.get("session_id_expiry")
        })
        return _obj


# Pydantic v2: resolve forward references & Annotated types
CreateSubscriptionRequestSubscriptionMeta.model_rebuild()
