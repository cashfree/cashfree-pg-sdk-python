...
**preferred_evidence** | [**List[PreferredEvidenceInner]**](PreferredEvidenceInner.md) |  | [optional] 
**dispute_evidence** | [**List[DisputeEvidenceInner]**](DisputeEvidenceInner.md) |  | [optional] 
...
disputes_entity_merchant_accepted_form_dict = disputes_entity_merchant_accepted.from_dict(disputes_entity_merchant_accepted_dict)
```
