...
class PaymentMethodsQueries(BaseModel):
    ...
    """
    amount: Optional[Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="Amount of the order.")
    ...
    def from_json_for_one_of(cls, json_str: str) -> PaymentMethodsQueries:
        ...
        if "amount, order_id" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
...
PaymentMethodsQueries.model_rebuild()
