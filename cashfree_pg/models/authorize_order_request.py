...
class AuthorizeOrderRequest(BaseModel):
    ...
    """
    action: Optional[StrictStr] = Field(default=None, description="Type of authorization to run. Can be one of 'CAPTURE' , 'VOID'")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount if you are running a 'CAPTURE'")
