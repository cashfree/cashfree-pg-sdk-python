...
class LinkEntity(BaseModel):
    ...
    def from_json_for_one_of(cls, json_str: str) -> LinkEntity:
        ...
        if temp_dict["cf_link_id, link_id, link_status, link_currency, link_amount, link_amount_paid, link_partial_payments, link_minimum_partial_amount, link_purpose, link_created_at, customer_details, link_meta, link_url, link_expiry_time, link_notes, link_auto_reminders, link_notify"] in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
