...
class EvidencesToContestDispute(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EvidencesToContestDispute:
        """Create an instance of EvidencesToContestDispute from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> EvidencesToContestDispute:
        """Create an instance of EvidencesToContestDispute from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EvidencesToContestDispute:
        """Create an instance of EvidencesToContestDispute from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EvidencesToContestDispute.parse_obj(obj)

        _obj = EvidencesToContestDispute.parse_obj({
...
EvidencesToContestDispute.model_rebuild()
