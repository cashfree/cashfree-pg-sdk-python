...
class SettlementReconEntity(BaseModel):
    ...
    limit: Optional[StrictInt] = Field(default=None, description="Number of settlements you want to fetch in the next iteration.")
    data: Optional[List[SettlementReconEntityDataInner]] = None
    ...
    def from_json_for_one_of(cls, json_str: str) -> SettlementReconEntity:
        ...
        if "cursor, limit, data" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
...
SettlementReconEntity.model_rebuild()
