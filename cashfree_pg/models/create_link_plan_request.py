...
class CreateLinkPlanRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateLinkPlanRequest:
        """Create an instance of CreateLinkPlanRequest from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> CreateLinkPlanRequest:
        """Create an instance of CreateLinkPlanRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateLinkPlanRequest:
        """Create an instance of CreateLinkPlanRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateLinkPlanRequest.parse_obj(obj)

        _obj = CreateLinkPlanRequest.parse_obj({
...
CreateLinkPlanRequest.model_rebuild()
