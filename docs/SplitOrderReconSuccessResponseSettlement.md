...
split_order_recon_success_response_settlement_from_dict = SplitOrderReconSuccessResponseSettlement.from_dict(split_order_recon_success_response_settlement_dict)
```
