...
class TerminalEntity(BaseModel):
    ...
    def from_json_for_one_of(cls, json_str: str) -> TerminalEntity:
        """Create an instance of TerminalEntity from a JSON string"""
        if "added_oncf_terminal_idlast_updated_onterminal_addressterminal_emailterminal_typeteminal_idterminal_nameterminal_noteterminal_phone_noterminal_statusterminal_meta" not in json_str:
            return None
        return cls.from_dict(json.loads(json_str))
