...
class PlanEntity(BaseModel):
    ...
    """
    plan_currency: Optional[StrictStr] = Field(default=None, description="Currency for the plan.")
    plan_id: Optional[StrictStr] = Field(default=None, description="Plan ID provided by merchant.")
    plan_interval_type: Optional[StrictStr] = Field(default=None, description="Interval type for the plan.")
    plan_intervals: Optional[StrictInt] = Field(default=None, description="Number of intervals for the plan.")
    ...
    plan_recurring_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Recurring amount for the plan.")
    plan_status: Optional[StrictStr] = Field(default=None, description="Status of the plan.")
    plan_type: Optional[StrictStr] = Field(default=None, description="Type of the plan.")
