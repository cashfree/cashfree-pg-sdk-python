...
class CardlessEMIEntity(BaseModel):
    ...
    cardless EMI object
    """
    payment_method: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=50)]] = None
    emi_plans: Optional[List[EMIPlansArray]] = None
    ...
    def from_json_for_one_of(cls, json_str: str) -> CardlessEMIEntity:
        ...
        if "payment_method, emi_plans" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
...
CardlessEMIEntity.model_rebuild()
