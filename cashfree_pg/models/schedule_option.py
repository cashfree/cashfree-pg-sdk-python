...
class ScheduleOption(BaseModel):
    ...
    ScheduleOption
    """
    settlement_schedule_message: Optional[StrictStr] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScheduleOption:
        """Create an instance of ScheduleOption from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> ScheduleOption:
        """Create an instance of ScheduleOption from a JSON string"""
        temp_dict = json.loads(json_str)
        if "settlement_schedule_message, schedule_id, merchant_default" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScheduleOption:
