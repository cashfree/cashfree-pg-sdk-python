...
**token_reference_id** | **str** | Token Reference Id provided by Diners for Guest Checkout Token.  Required only for Diners cards. | [optional] 
...
**zip_code** | **str** | Pin Code/Zip Code. | [optional] 
**country** | **str** | Country Name. | [optional] 
**country_code** | **str** | Country Code. Should be in ISO 2 format (ie. US for United States) | [optional] 
**state** | **str** | State Name. | [optional] 
**state_code** | **str** | State Code. Should be in ISO 2 format (ie. FL for Florida) | [optional] 
