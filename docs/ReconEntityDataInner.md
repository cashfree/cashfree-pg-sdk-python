...
**forex_conversion_handling_charge** | **float** | Cashfree forex conversion charges for processing transaction | [optional] 
**forex_conversion_handling_tax** | **float** | Cashfree forex conversion tax for processing transaction | [optional] 
**charges_currency** | **str** | Cashfree charges currency for a event type | [optional] 
