...
class EligibilityCardlessEMIEntity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EligibilityCardlessEMIEntity:
  ...
  &quot;example&quot; : true
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EligibilityCardlessEMIEntity:
        """Create an instance of EligibilityCardlessEMIEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EligibilityCardlessEMIEntity.parse_obj(obj)

        _obj = EligibilityCardlessEMIEntity.parse_obj({
            "eligibility": obj.get("eligibility"),
            "entity_type": obj.get("entity_type"),
            "entity_value": obj.get("entity_value"),
            "entity_details": CardlessEMIEntity.from_dict(obj.get("entity_details")) if obj.get("entity_details") is not None else None
        })
        return _obj
