            ...
            return PaymentWebhookDataEntity(
                ...
                payment_offers = [
                    cashfree_pg.models.offer_entity.OfferEntity(
                        ...
                        offer_meta = {"$ref":"#/components/schemas/OfferMetaResponse/example"}, 
                        offer_tnc = {"$ref":"#/components/schemas/OfferTncResponse/example"}, 
                        offer_details = {"$ref":"#/components/schemas/OfferDetailsResponse/example"}, 
                        offer_validations = {"$ref":"#/components/schemas/OfferValidationsResponse/example"}, 
