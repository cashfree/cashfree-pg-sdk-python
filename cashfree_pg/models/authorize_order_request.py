...
class AuthorizeOrderRequest(BaseModel):
    ...
    """
    action: StrictStr = Field(description="Type of authorisation to run. Available options are `CAPTURE`, `VOID`.")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount you want to capture. This is required only when action is `CAPTURE`.")
...
AuthorizeOrderRequest.model_rebuild()
