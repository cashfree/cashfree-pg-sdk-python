...
class CreateVendorRequest(BaseModel):
    ...
    """
    vendor_id: StrictStr = Field(description="Specify the unique Vendor ID to identify the beneficiary. Alphanumeric and underscore (_) allowed.")
    ...
    kyc_details: List[KycDetails] = Field(description="Specify the kyc details that should be updated.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateVendorRequest:
        """Create an instance of CreateVendorRequest from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> CreateVendorRequest:
        """Create an instance of CreateVendorRequest from a JSON string"""
        temp_dict = json.loads(json_str)
        if "vendor_id, status, name, email, phone, verify_account, dashboard_access, schedule_option, bank, upi, kyc_details" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateVendorRequest:
...
CreateVendorRequest.model_rebuild()
