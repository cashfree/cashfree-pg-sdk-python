...
payment_method_card_emiin_payments_entity_emi_from_dict = PaymentMethodCardEMIInPaymentsEntityEmi.from_dict(payment_method_card_emiin_payments_entity_emi_dict)
```
