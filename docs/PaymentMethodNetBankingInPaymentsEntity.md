...
payment_method_net_banking_in_payments_entity_from_dict = PaymentMethodNetBankingInPaymentsEntity.from_dict(payment_method_net_banking_in_payments_entity_dict)
```
