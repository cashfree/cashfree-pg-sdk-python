...
class SplitOrderReconSuccessResponseSettlement(BaseModel):
    ...
    """
    entity: Optional[StrictStr] = Field(default=None, description="Type of entity. Example: \"settlement\".")
    cf_settlement_id: Optional[StrictInt] = Field(default=None, description="Unique Cashfree settlement ID.")
    cf_payment_id: Optional[StrictInt] = Field(default=None, description="Unique Cashfree payment ID associated with the order.")
    ...
    transfer_id: Optional[StrictStr] = Field(default=None, description="Unique transfer ID if available, otherwise null.")
    order_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount of the order.")
    service_charge: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Service charge for the order.")
    service_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Service tax for the order.")
    settlement_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount to be settled after charges and tax.")
    settlement_currency: Optional[StrictStr] = Field(default=None, description="Currency of the settlement. Example: \"INR\".")
    transfer_utr: Optional[StrictStr] = Field(default=None, description="UTR (Unique Transaction Reference) for the transfer if available, otherwise null.")
    transfer_time: Optional[StrictStr] = Field(default=None, description="Time of transfer if available, otherwise null.")
    payment_time: Optional[StrictStr] = Field(default=None, description="Timestamp when payment was made.")
...
SplitOrderReconSuccessResponseSettlement.model_rebuild()
