...
class CreatePlanRequest(BaseModel):
    ...
    plan_currency: Optional[StrictStr] = Field(default=None, description="Currency of the plan. For plans in non-INR currency, please refer to [supported currencies](https://www.cashfree.com/docs/payments/international-payments/ipg/currencies-supported#full-currency-list).")
