...
class SettlementEntity(BaseModel):
    ...
    forex_conversion_handling_charge: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cashfree forex conversion charges for refund processing.")
    forex_conversion_handling_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cashfree forex conversion tax for refund processing.")
    forex_conversion_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cashfree forex conversion rate for refund processing.")
    charges_currency: Optional[StrictStr] = Field(default=None, description="Cashfree refund charges currency for a refund.")
    __properties = ["cf_payment_id", "cf_settlement_id", "settlement_currency", "order_id", "entity", "order_amount", "payment_time", "service_charge", "service_tax", "settlement_amount", "settlement_id", "transfer_id", "transfer_time", "transfer_utr", "forex_conversion_handling_charge", "forex_conversion_handling_tax", "forex_conversion_rate", "charges_currency"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> SettlementEntity:
        ...
        if "cf_payment_id, cf_settlement_id, settlement_currency, order_id, entity, order_amount, payment_time, service_charge, service_tax, settlement_amount, settlement_id, transfer_id, transfer_time, transfer_utr, forex_conversion_handling_charge, forex_conversion_handling_tax, forex_conversion_rate, charges_currency" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def from_dict(cls, obj: dict) -> SettlementEntity:
        ...
        _obj = SettlementEntity.parse_obj({
            ...
            "forex_conversion_rate": obj.get("forex_conversion_rate"),
...
SettlementEntity.model_rebuild()
