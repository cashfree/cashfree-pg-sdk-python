...
class PayOrderRequest(BaseModel):
    ...
    PayOrderRequest
    """
    payment_session_id: StrictStr = Field(description="Unique identifier for the payment session, returned in the response of the Create Order API.")
    payment_method: PayOrderRequestPaymentMethod
    save_instrument: Optional[StrictBool] = Field(default=None, description="Send as **true** if the customer has given consent to save or tokenise the card; otherwise, send as false.")
