...
payment_method_bank_transfer_in_payments_entity_from_dict = PaymentMethodBankTransferInPaymentsEntity.from_dict(payment_method_bank_transfer_in_payments_entity_dict)
```
