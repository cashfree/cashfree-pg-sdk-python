...
class TestSimulationApi(unittest.TestCase):
    ...
    def test_p_g_fetch_settlement_simulation(self):
        """Test case for p_g_fetch_settlement_simulation
    ...
    def test_p_g_simulate_settlement(self):
        """Test case for p_g_simulate_settlement
