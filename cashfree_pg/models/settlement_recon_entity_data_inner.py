...
class SettlementReconEntityDataInner(BaseModel):
    ...
    cf_payment_id: Optional[StrictStr] = Field(None, description="Cashfree Payments unique ID to identify a payment.")
    cf_settlement_id: Optional[StrictStr] = Field(None, description="Unique ID to identify the settlement.")
    ...
    def from_dict(cls, obj: dict) -> SettlementReconEntityDataInner:
        ...
        if not isinstance(obj, dict):
            return SettlementReconEntityDataInner.model_validate(obj)

        _obj = SettlementReconEntityDataInner.model_validate({
