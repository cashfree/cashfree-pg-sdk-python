...
# **PGCreateOffer**
> OfferEntity PGCreateOffer(x_api_version, create_offer_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
from pprint import pprint
    ...
    try:
        # Create Offer
        api_response = Cashfree().PGCreateOffer(x_api_version, create_offer_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of OffersApi->PGCreateOffer:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OffersApi->PGCreateOffer: %s\n" % e)
```
...
# **PGFetchOffer**
> OfferEntity PGFetchOffer(x_api_version, offer_id, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
from pprint import pprint
    ...
    try:
        # Get Offer by ID
        api_response = Cashfree().PGFetchOffer(x_api_version, offer_id, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of OffersApi->PGFetchOffer:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OffersApi->PGFetchOffer: %s\n" % e)
```
