...
class OfferEntity(BaseModel):
    ...
    payable_amount: Optional[Union[StrictFloat, StrictInt]] = None
    offer_meta: Optional[OfferMetaResponse] = None
    offer_tnc: Optional[OfferTncResponse] = None
    offer_details: Optional[OfferDetailsResponse] = None
    offer_validations: Optional[OfferValidationsResponse] = None
    redemption_amount: Optional[Union[StrictFloat, StrictInt]] = None
    platform: Optional[StrictStr] = None
    __properties = ["offer_id", "offer_status", "order_amount", "payable_amount", "offer_meta", "offer_tnc", "offer_details", "offer_validations", "redemption_amount", "platform"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> OfferEntity:
        ...
        if "offer_id, offer_status, order_amount, payable_amount, offer_meta, offer_tnc, offer_details, offer_validations, redemption_amount, platform" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def from_dict(cls, obj: dict) -> OfferEntity:
        ...
        _obj = OfferEntity.parse_obj({
            ...
            "offer_meta": OfferMetaResponse.from_dict(obj.get("offer_meta")) if obj.get("offer_meta") is not None else None,
            "offer_tnc": OfferTncResponse.from_dict(obj.get("offer_tnc")) if obj.get("offer_tnc") is not None else None,
            "offer_details": OfferDetailsResponse.from_dict(obj.get("offer_details")) if obj.get("offer_details") is not None else None,
            "offer_validations": OfferValidationsResponse.from_dict(obj.get("offer_validations")) if obj.get("offer_validations") is not None else None,
            "redemption_amount": obj.get("redemption_amount"),
