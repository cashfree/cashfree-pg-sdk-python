...
class CreateSubscriptionPaymentResponse(BaseModel):
    ...
    payment_initiated_date: Optional[StrictStr] = Field(default=None, description="The date on which the payment was initiated. We store timestamps in IST.")
    ...
    payment_method: Optional[StrictStr] = Field(default=None, description="Payment method used for the authorisation.")
