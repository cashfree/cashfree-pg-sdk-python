...
class SubscriptionPaymentEntity(BaseModel):
    ...
    payment_initiated_date: Optional[StrictStr] = Field(default=None, description="The date on which the payment was initiated. Cashfree stores timestamps in IST.")
    payment_remarks: Optional[StrictStr] = Field(default=None, description="Payment remarks.")
    payment_schedule_date: Optional[StrictStr] = Field(default=None, description="The date on which the payment is scheduled to be processed. Cashfree stores timestamps in IST, but you can provide them in a valid ISO 8601 time format.  For IST this `2025-06-01T10:20:12+05:30` translates to `2025-06-01 10:20:12`    For UTC this `2025-06-01T10:20:12Z` translates to `2025-06-01 15:50:12+05:30`.")
...
SubscriptionPaymentEntity.model_rebuild()
