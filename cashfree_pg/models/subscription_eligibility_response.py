...
class SubscriptionEligibilityResponse(BaseModel):
    ...
    """
    type: Optional[List[EligibilityMethodItem]] = Field(default=None, description="List of eligibile payment methods for the subscription.")
    __properties = ["type"]
...
SubscriptionEligibilityResponse.model_rebuild()
