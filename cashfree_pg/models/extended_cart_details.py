...
class ExtendedCartDetails(BaseModel):
    ...
    """
    name: Optional[StrictStr] = Field(default=None, description="Name of the cart.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtendedCartDetails:
        """Create an instance of ExtendedCartDetails from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> ExtendedCartDetails:
        """Create an instance of ExtendedCartDetails from a JSON string"""
        temp_dict = json.loads(json_str)
        if "name, items" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtendedCartDetails:
...
ExtendedCartDetails.model_rebuild()
