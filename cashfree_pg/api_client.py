...
class Cashfree:
    ...
    def PGCreateCustomer(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, create_customer_request : Annotated[CreateCustomerRequest, Field(..., description="Request to create a new customer at Cashfree")] = None, x_request_id : Annotated[Optional[StrictStr], Field(description="Request id for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to cashfree")] = None, x_idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.  ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        _header_params["x-sdk-platform"] = "pythonsdk-4.0.8"
    ...
    @validate_arguments
    def PGOrderSplitAfterPayment(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, order_id : Annotated[StrictStr, Field(..., description="The id which uniquely identifies your order")] = None, split_after_payment_request : Annotated[Optional[SplitAfterPaymentRequest], Field(description="Request Body to Create Split for an order.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGOrderSplitAfterPayment_with_http_info(x_api_version, order_id, split_after_payment_request, async_req=True)
        >>> result = thread.get()
        ...
        return api_client.call_api(
            ...
            _request_auth=_params.get('_request_auth'))
    @validate_arguments
    def PGOrderStaticSplit(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, static_split_request : Annotated[Optional[StaticSplitRequest], Field(description="Static Split")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGOrderStaticSplit_with_http_info(x_api_version, static_split_request, async_req=True)
        >>> result = thread.get()
    ...
    def PGesCreateOnDemandTransfer(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, vendor_id : Annotated[StrictStr, Field(..., description="The id which uniquely identifies your vendor.")] = None, adjust_vendor_balance_request : Annotated[Optional[AdjustVendorBalanceRequest], Field(description="Adjust Vendor Balance Request Body.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesCreateOnDemandTransfer_with_http_info(x_api_version, vendor_id, adjust_vendor_balance_request, async_req=True)
        >>> result = thread.get()
        ...
        return api_client.call_api(
            ...
            _request_auth=_params.get('_request_auth'))
    @validate_arguments
    def PGesCreateVendors(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, create_vendor_request : Annotated[Optional[CreateVendorRequest], Field(description="Create Vendor Request Body.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesCreateVendors_with_http_info(x_api_version, create_vendor_request, async_req=True)
        >>> result = thread.get()
    ...
    def PGesDownloadVendorsDocs(self, doc_type : Annotated[StrictStr, Field(..., description="Mention the document type that has to be downloaded. Only an uploaded document can be downloaded.")] = None, vendor_id : Annotated[StrictStr, Field(..., description="The id which uniquely identifies your vendor.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesDownloadVendorsDocs_with_http_info(doc_type, vendor_id, async_req=True)
        >>> result = thread.get()
        ...
        return api_client.call_api(
            ...
            _request_auth=_params.get('_request_auth'))
    @validate_arguments
    def PGesFetchVendors(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, vendor_id : Annotated[StrictStr, Field(..., description="The id which uniquely identifies your vendor.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesFetchVendors_with_http_info(x_api_version, vendor_id, async_req=True)
        >>> result = thread.get()
        ...
        return api_client.call_api(
            ...
            _request_auth=_params.get('_request_auth'))
    @validate_arguments
    def PGesGetVendorBalance(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, vendor_id : Annotated[StrictStr, Field(..., description="The id which uniquely identifies your vendor.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesGetVendorBalance_with_http_info(x_api_version, vendor_id, async_req=True)
        >>> result = thread.get()
    ...
    def PGesGetVendorBalanceTransferCharges(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, amount : Annotated[Union[StrictFloat, StrictInt], Field(..., description="Specify the amount for which you want to view the service charges and service taxes in the response.")] = None, rate_type : Annotated[StrictStr, Field(..., description="Mention the type of rate for which you want to check the charges. Possible value: VENDOR_ON_DEMAND")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesGetVendorBalanceTransferCharges_with_http_info(x_api_version, amount, rate_type, async_req=True)
        >>> result = thread.get()
        ...
        return api_client.call_api(
            ...
            _request_auth=_params.get('_request_auth'))
    @validate_arguments
    def PGesGetVendorsDocs(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, vendor_id : Annotated[StrictStr, Field(..., description="The id which uniquely identifies your vendor.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesGetVendorsDocs_with_http_info(x_api_version, vendor_id, async_req=True)
        >>> result = thread.get()
        ...
        return api_client.call_api(
            ...
            _request_auth=_params.get('_request_auth'))
    @validate_arguments
    def PGesOrderRecon(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, es_order_recon_request : Annotated[Optional[ESOrderReconRequest], Field(description="Get Split and Settlement Details by OrderID v2.0")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesOrderRecon_with_http_info(x_api_version, es_order_recon_request, async_req=True)
        >>> result = thread.get()
    ...
    def PGesUpdateVendors(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, vendor_id : Annotated[StrictStr, Field(..., description="The id which uniquely identifies your vendor.")] = None, update_vendor_request : Annotated[Optional[UpdateVendorRequest], Field(description="Create Vendor Request Body.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesUpdateVendors_with_http_info(x_api_version, vendor_id, update_vendor_request, async_req=True)
        >>> result = thread.get()
    ...
    def PGesUploadVendorsDocs(self, x_api_version : Annotated[StrictStr, Field(..., description="API version to be used. Format is in YYYY-MM-DD")] = None, vendor_id : Annotated[StrictStr, Field(..., description="The id which uniquely identifies your vendor.")] = None, upload_vendor_docs_request : Annotated[Optional[UploadVendorDocsRequest], Field(description="Upload Vendor Docs Request Body.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.PGesUploadVendorsDocs_with_http_info(x_api_version, vendor_id, upload_vendor_docs_request, async_req=True)
        >>> result = thread.get()
        ...
        :param vendor_id: The id which uniquely identifies your vendor. (required)
        :type vendor_id: str
        :param upload_vendor_docs_request: Upload Vendor Docs Request Body.
        :type upload_vendor_docs_request: UploadVendorDocsRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the ApiResponse.data will
                                 be set to none and raw_data will store the 
        ...
        # process the body parameter
        _body_params = None
        if _params['upload_vendor_docs_request'] is not None:
            _body_params = _params['upload_vendor_docs_request']
