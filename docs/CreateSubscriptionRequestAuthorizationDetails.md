...
create_subscription_request_authorization_details_from_dict = CreateSubscriptionRequestAuthorizationDetails.from_dict(create_subscription_request_authorization_details_dict)
```
