...
class SettlementsApi(object):
    ...
    def getsettlements(self, x_client_id, x_client_secret, order_id, **kwargs):  # noqa: E501
        """Get Settlements  # noqa: E501

        Use this API to view all the settlements of a particular order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.getsettlements(x_client_id, x_client_secret, order_id, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: CFSettlementsEntity
        """
        kwargs['_return_http_data_only'] = True
        return self.getsettlements_with_http_info(x_client_id, x_client_secret, order_id, **kwargs)  # noqa: E501

    def getsettlements_with_http_info(self, x_client_id, x_client_secret, order_id, **kwargs):  # noqa: E501
        """Get Settlements  # noqa: E501
        ...
        >>> thread = api.getsettlements_with_http_info(x_client_id, x_client_secret, order_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CFSettlementsEntity, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if self.api_client.client_side_validation and local_var_params.get('x_client_id') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_client_id` when calling `getsettlements`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('x_client_secret') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_client_secret` when calling `getsettlements`")  # noqa: E501
        # verify the required parameter 'order_id' is set
        if self.api_client.client_side_validation and local_var_params.get('order_id') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `order_id` when calling `getsettlements`")  # noqa: E501
