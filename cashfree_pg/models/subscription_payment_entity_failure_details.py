...
class SubscriptionPaymentEntityFailureDetails(BaseModel):
    ...
    """
    failure_reason: Optional[StrictStr] = Field(default=None, description="Failure reason of the payment if the payment_status is failed.")
...
SubscriptionPaymentEntityFailureDetails.model_rebuild()
