...
class OrderDeliveryStatus(BaseModel):
    ...
    """
    status: Optional[StrictStr] = Field(default=None, description="Delivery status of order.")
    reason: Optional[StrictStr] = Field(default=None, description="Reason of provided order delivery status. This is optional field.")
...
OrderDeliveryStatus.model_rebuild()
