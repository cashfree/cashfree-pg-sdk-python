# cashfree_pg.OffersApi

All URIs are relative to *https://sandbox.cashfree.com/pg*

Method | HTTP request | Description
------------- | ------------- | -------------
[**p_g_create_offer**](OffersApi.md#p_g_create_offer) | **POST** /offers | Create Offer
[**p_g_fetch_offer**](OffersApi.md#p_g_fetch_offer) | **GET** /offers/{offer_id} | Get Offer by ID


# **p_g_create_offer**
> OfferEntity p_g_create_offer(x_api_version, create_offer_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
with cashfree_pg.ApiClient(configuration) as api_client:
    ...
    api_instance = cashfree_pg.OffersApi(api_client)
    x_api_version = '2023-08-01' # str | API version to be used. Format is in YYYY-MM-DD (default to '2023-08-01')
    create_offer_request = cashfree_pg.CreateOfferRequest() # CreateOfferRequest | Request body to create an offer at Cashfree
    ...
    try:
        # Create Offer
        api_response = api_instance.p_g_create_offer(x_api_version, create_offer_request, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of OffersApi->p_g_create_offer:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OffersApi->p_g_create_offer: %s\n" % e)
```
 ...
 **create_offer_request** | [**CreateOfferRequest**](CreateOfferRequest.md)| Request body to create an offer at Cashfree | 
...
# **p_g_fetch_offer**
> OfferEntity p_g_fetch_offer(x_api_version, offer_id, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
...
with cashfree_pg.ApiClient(configuration) as api_client:
    ...
    api_instance = cashfree_pg.OffersApi(api_client)
    x_api_version = '2023-08-01' # str | API version to be used. Format is in YYYY-MM-DD (default to '2023-08-01')
    offer_id = 'd2b430fb-1afe-455a-af31-66d00377b29a' # str | The offer ID for which you want to view the offer details.
    x_request_id = '4dfb9780-46fe-11ee-be56-0242ac120002' # str | Request id for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to cashfree (optional)
    x_idempotency_key = '47bf8872-46fe-11ee-be56-0242ac120002' # str | An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.   (optional)

    try:
        # Get Offer by ID
        api_response = api_instance.p_g_fetch_offer(x_api_version, offer_id, x_request_id=x_request_id, x_idempotency_key=x_idempotency_key)
        print("The response of OffersApi->p_g_fetch_offer:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OffersApi->p_g_fetch_offer: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **x_api_version** | **str**| API version to be used. Format is in YYYY-MM-DD | [default to &#39;2023-08-01&#39;]
 **offer_id** | **str**| The offer ID for which you want to view the offer details. | 
 **x_request_id** | **str**| Request id for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to cashfree | [optional] 
 **x_idempotency_key** | **str**| An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions.   | [optional] 
