...
class PayOrderEntity(BaseModel):
    ...
    payment_method: Optional[StrictStr] = Field(default=None, description="One of [\"upi\", \"netbanking\", \"card\", \"app\", \"cardless_emi\", \"paylater\", \"banktransfer\"] ")
    channel: Optional[StrictStr] = Field(default=None, description="One of [\"link\", \"collect\", \"qrcode\"]. In an older version we used to support different channels like 'gpay', 'phonepe' etc. However, we now support only the following channels - link, collect and qrcode. To process payments using gpay, you will have to provide channel as 'link' and provider as 'gpay'")
    action: Optional[StrictStr] = Field(default=None, description="One of [\"link\", \"custom\", \"form\"]")
