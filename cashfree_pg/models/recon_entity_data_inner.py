...
class ReconEntityDataInner(BaseModel):
    ...
    def from_json_for_one_of(cls, json_str: str) -> ReconEntityDataInner:
        """Create an instance of ReconEntityDataInner from a JSON string"""
        if "event_idevent_typeevent_settlement_amountevent_amountsale_typeevent_statusentityevent_timeevent_currencyorder_idorder_amountcustomer_phonecustomer_emailcustomer_namepayment_amountpayment_utrpayment_timepayment_service_chargepayment_service_taxcf_payment_idcf_settlement_idsettlement_datesettlement_utrsplit_service_chargesplit_service_taxvendor_commissionclosed_in_favor_ofdispute_resolved_ondispute_categorydispute_noterefund_processed_atrefund_arnrefund_noterefund_idadjustment_remarksadjustmentservice_taxservice_chargeamount_settledpayment_frompayment_tillreasonsettlement_initiated_onsettlement_typesettlement_chargesettlement_taxremarks" not in json_str:
            return None
        return cls.from_dict(json.loads(json_str))
