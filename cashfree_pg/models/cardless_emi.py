...
from pydantic import BaseModel, Field, StrictInt, StrictStr, field_validator, ConfigDict
...
class CardlessEMI(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CardlessEMI:
        ...
        if not isinstance(obj, dict):
            return CardlessEMI.model_validate(obj)

        _obj = CardlessEMI.model_validate({
