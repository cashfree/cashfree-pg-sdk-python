...
class UpdateVendorRequest(BaseModel):
    ...
    """
    status: Optional[StrictStr] = Field(default=None, description="Specify the status of vendor that should be updated. Possible value: ACTIVE.")
    name: Optional[StrictStr] = Field(default=None, description="Specify the name of the vendor to be updated. Name should not have any special character except . / - &.")
    email: Optional[StrictStr] = Field(default=None, description="Specify the vendor email ID that should be updated. String in email ID format (Ex:johndoe_1@cashfree.com) should contain @ and dot (.).")
    phone: Optional[StrictStr] = Field(default=None, description="Specify the beneficiaries phone number to be updated. Phone number registered in India (only digits, 8 - 12 characters after excluding +91).")
    verify_account: Optional[StrictBool] = Field(default=None, description="Specify if the vendor bank account details should be verified. Possible values: true or false.")
    dashboard_access: Optional[StrictBool] = Field(default=None, description="Update if the vendor will have dashboard access or not. Possible values are: true or false.")
    schedule_option: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Specify the settlement cycle to be updated. View the settlement cycle details from the \"Settlement Cycles Supported\" table. If no schedule option is configured, the settlement cycle ID \"1\" will be in effect. Select \"8\" or \"9\" if you want to schedule instant vendor settlements.")
    bank: Optional[List[BankDetails]] = Field(default=None, description="Specify the vendor bank account details to be updated.")
    upi: Optional[List[UpiDetails]] = Field(default=None, description="Updated beneficiary upi vpa. Alphanumeric, dot (.), hyphen (-), at sign (@), and underscore allowed (100 character limit). Note: underscore and dot (.) gets accepted before and after @, but hyphen (-) is only accepted before @ sign.")
    kyc_details: Optional[List[KycDetails]] = Field(default=None, description="Specify the kyc details that should be updated.")
