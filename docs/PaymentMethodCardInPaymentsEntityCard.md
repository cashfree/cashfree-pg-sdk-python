...
payment_method_card_in_payments_entity_card_from_dict = PaymentMethodCardInPaymentsEntityCard.from_dict(payment_method_card_in_payments_entity_card_dict)
```
