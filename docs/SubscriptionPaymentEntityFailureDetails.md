...
subscription_payment_entity_failure_details_form_dict = subscription_payment_entity_failure_details.from_dict(subscription_payment_entity_failure_details_dict)
```
