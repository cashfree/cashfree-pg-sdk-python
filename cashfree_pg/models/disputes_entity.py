...
class DisputesEntity(BaseModel):
    ...
    dispute_amount_currency: Optional[StrictStr] = Field(default=None, description="Dispute amount currency for a dispute.")
    ...
    __properties = ["dispute_id", "dispute_type", "reason_code", "reason_description", "dispute_amount", "dispute_amount_currency", "created_at", "respond_by", "updated_at", "resolved_at", "dispute_status", "cf_dispute_remarks", "preferred_evidence", "dispute_evidence", "order_details", "customer_details"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DisputesEntity:
        """Create an instance of DisputesEntity from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> DisputesEntity:
        """Create an instance of DisputesEntity from a JSON string"""
        temp_dict = json.loads(json_str)
        if "dispute_id, dispute_type, reason_code, reason_description, dispute_amount, dispute_amount_currency, created_at, respond_by, updated_at, resolved_at, dispute_status, cf_dispute_remarks, preferred_evidence, dispute_evidence, order_details, customer_details" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DisputesEntity:
        """Create an instance of DisputesEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DisputesEntity.parse_obj(obj)

        _obj = DisputesEntity.parse_obj({
            ...
            "dispute_amount_currency": obj.get("dispute_amount_currency"),
