...
class SubscriptionEligibilityRequestFilters(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionEligibilityRequestFilters:
        """Create an instance of SubscriptionEligibilityRequestFilters from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> SubscriptionEligibilityRequestFilters:
        """Create an instance of SubscriptionEligibilityRequestFilters from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionEligibilityRequestFilters:
        """Create an instance of SubscriptionEligibilityRequestFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionEligibilityRequestFilters.parse_obj(obj)

        _obj = SubscriptionEligibilityRequestFilters.parse_obj({
...
SubscriptionEligibilityRequestFilters.model_rebuild()
