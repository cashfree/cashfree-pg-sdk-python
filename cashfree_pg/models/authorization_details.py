...
class AuthorizationDetails(BaseModel):
    ...
    """
    authorization_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Authorization amount for the auth payment. Please note that authorization_amount will always be 0 for ENACH.")
    ...
    authorization_reference: Optional[StrictStr] = Field(default=None, description="Authorization reference. UMN for UPI, UMRN for EMandate/Physical Mandate and Enrollment ID for cards.")
    authorization_time: Optional[StrictStr] = Field(default=None, description="Authorization time. Cashfree stores timestamps in IST.")
    authorization_status: Optional[StrictStr] = Field(default=None, description="Status of the authorization.")
    ...
    payment_group: Optional[StrictStr] = Field(default=None, description="Payment group used for the authorization.")
    payment_method: Optional[AuthorizationDetailsPaymentMethod] = None
    __properties = ["authorization_amount", "authorization_amount_refund", "authorization_reference", "authorization_time", "authorization_status", "payment_id", "payment_group", "payment_method"]
    ...
    def from_json_for_one_of(cls, json_str: str) -> AuthorizationDetails:
        ...
        if "authorization_amount, authorization_amount_refund, authorization_reference, authorization_time, authorization_status, payment_id, payment_group, payment_method" in temp_dict.keys():
            return cls.from_dict(json.loads(json_str))
        return None
    ...
    def from_dict(cls, obj: dict) -> AuthorizationDetails:
        ...
        _obj = AuthorizationDetails.parse_obj({
            ...
            "payment_method": AuthorizationDetailsPaymentMethod.from_dict(obj.get("payment_method")) if obj.get("payment_method") is not None else None
        })
        return _obj


# Pydantic v2: resolve forward references & Annotated types
AuthorizationDetails.model_rebuild()
